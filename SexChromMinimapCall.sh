...
usage() {
  cat <<'EOF'
SexChromMinimapCall.sh: map scaffolds to a sex-chromosome reference (minimap2) and classify chr1/chr2 scaffolds from PAF.
...
Usage:
  SexChromMinimapCall.sh --chr1 TARGET1 --chr2 TARGET2 [options]
